...
LETHAL_TEMPO = 'ASSETS/Perks/Styles/Precision/LethalTempo/LethalTempoEmpowered.lua'
...
class OrbWalker:
    ...
    @staticmethod
    def get_attack_speed_cap(champion, game_time):
        uncapped = False
        uncapped |= any([buff.end_time > game_time for buff in champion.buffs[LETHAL_TEMPO]])
    ...
    def walk(self, stats, champion, x, y, game_time):
        ...
        attack_speed_cap = OrbWalker.get_attack_speed_cap(champion, game_time)
